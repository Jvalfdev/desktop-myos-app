...
| 7.2 | Integrar modal RGPD en creación | ✅ | Se abre automáticamente después de guardar |
| 7.3 | Validar RGPD obligatorio | ✅ | Verifica antes de continuar |
...
| # | Tarea | Estado | Notas |
|---|-------|--------|-------|
| 8.1 | Modificar `TrabajosViewModel` | ⏳ | Verificar RGPD del cliente |
| 8.2 | Validar RGPD antes de guardar trabajo | ⏳ | Bloquear si no tiene |
| 8.3 | Integrar modal Trabajo en creación | ⏳ | Abrir antes de guardar |
| 8.4 | Vincular consentimiento a trabajo | ⏳ | TrabajoId en Consentimiento |
| 8.5 | Mostrar alerta si falta RGPD | ⏳ | Con botón "Ir a firmar RGPD" |
...
Fase 8: Integración en Trabajos       [░░░░░░░░░░░░░░░░░░░░]   0%
Fase 9: Vista de Consentimientos      [░░░░░░░░░░░░░░░░░░░░]   0%
...
- ✅ **Fase 7 completada:**
  ...
  - Verificación de RGPD antes de continuar
  - Modal RGPD se abre automáticamente al crear nuevo cliente
...
### Flujo 1: Crear Cliente con RGPD

```
1. Usuario abre "Nuevo Cliente"
2. Rellena datos del cliente
3. Click "Guardar"
4. Sistema verifica: ¿Tiene RGPD?
   └─ NO → Abre modal de firma RGPD
      ...
      └─ Continúa guardando cliente
   └─ SÍ → Guarda cliente directamente
```
