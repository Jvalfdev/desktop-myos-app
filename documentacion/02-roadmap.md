...
| Tarea | Estado | Notas |
|-------|--------|-------|
| ClientesViewModel | ⏳ Pendiente | |
| ClientesView (lista) | ⏳ Pendiente | |
| ClienteDetalleView (ficha) | ⏳ Pendiente | |
| CRUD de clientes | ⏳ Pendiente | |
| Búsqueda de clientes | ⏳ Pendiente | |
